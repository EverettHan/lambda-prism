 ...
 */
  const char32_t ConvertToChar32() const;
  
  /** @nodoc */
  const CATUC4Bytes ConvertToUCChar32() const;
...
inline CATUnicodeChar CATUnicodeChar::BuildFromChar32(const char32_t iUChar32) { return BuildFromUCChar32(static_cast<const CATUC4Bytes>(iUChar32)); }
...
inline bool CATUnicodeChar::operator >= (const CATUnicodeChar & iCharacter) const { return !operator < (iCharacter); }
inline const char32_t    CATUnicodeChar::ConvertToChar32 () const { return static_cast<char32_t>(_UChar32); }
inline const CATUC4Bytes CATUnicodeChar::ConvertToUCChar32() const { return _UChar32; }
