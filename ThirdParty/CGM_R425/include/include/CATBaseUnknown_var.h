...
#if defined(_HPUX_SOURCE) || defined(_WINDOWS_SOURCE) || defined(_LINUX_SOURCE)|| defined(_DARWIN_SOURCE) || defined (_MACOSX_SOURCE) || (defined(_AIX_SOURCE) && (__xlC__ >= 0x0500)) || (defined(_SUNOS_SOURCE) && (defined(__SUNPRO_CC) && (__SUNPRO_CC > 0x420)))
