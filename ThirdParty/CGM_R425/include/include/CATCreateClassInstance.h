...
static char LocalFillDictionary__##class = CATFillDictionary::RegisterFunctionCreation(#class,OMFactoryFunct##class);
...
static char LocalFillDictionary__##keyname = CATFillDictionary::RegisterFunctionCreation(#keyname,OMFactoryFunct##class);
...
static char LocalFillDictionary__##keyname = CATFillDictionary::RegisterFunctionCreation(#keyname,MyFunction);
