...
//
#if defined(NATIVE_EXCEPTION) || defined(_CXX_EXCEPTION_SUPPORT)
/** @nodoc */
...
#else   // defined(NATIVE_EXCEPTION) || defined(_CXX_EXCEPTION_SUPPORT)
/** @nodoc */
# define CAT_DECLARE_RAISE(thisClass,baseClass)
/** @nodoc */
# define CAT_IMPLEMENT_RAISE(thisClass)
#endif  // defined(NATIVE_EXCEPTION) || defined(_CXX_EXCEPTION_SUPPORT)
