...
/** @name Comparison Methods
   ...
   */
  INLINE int Equal (const double a, const double b) const;

  /**
   * Returns +1 if the two points have the same geometrical position and 0 otherwise.
   */
  INLINE int Equal (const CATMathPoint2D& A, const CATMathPoint2D& B) const;

  /**
   * Returns +1 if the two points have the same geometrical position and 0 otherwise.
   */
  INLINE int Equal (const CATMathPoint& A, const CATMathPoint& B) const;
   ...
   */
  int CompareLeftRight (const CATMathPoint2D& A, const CATMathPoint2D& B) const;
   ...
   */
  int CompareBelowAbove (const CATMathPoint2D& A, const CATMathPoint2D& B) const;
...
/** @name Orientation Methods
   ...
   *     </ul>
   */
  int Orientation2D (const CATMathPoint2D& A, const CATMathPoint2D& B, const CATMathPoint2D& C) const;
   ...
   *     </ul>
   */
  int Orientation2D (const double a[2], const double b[2], const double c[2]) const;
...
INLINE int CATPolyExactArithmetic::Equal (const double a, const double b) const
{
  return a == b ? 1 : 0;
}

INLINE int CATPolyExactArithmetic::Equal (const CATMathPoint2D& A, const CATMathPoint2D& B) const
{
  return (A.GetX () == B.GetX () && A.GetY () == B.GetY ()) ? 1 : 0;
}

INLINE int CATPolyExactArithmetic::Equal (const CATMathPoint& A, const CATMathPoint& B) const
{
  return (A.GetX () == B.GetX () && A.GetY () == B.GetY () && A.GetZ () == B.GetZ ()) ? 1 : 0;
}

INLINE int CATPolyExactArithmetic::Compare (const double a, const double b) const
{
