<Profiles xmlns="http://tempuri.org/XMLSchema.xsd">
  ...
  <Profile name="DecoratePortsAndCnxs" OldTypingSupport='Y'> <!-- attention aux fasteners ...-->
    <Type>PLMCoreReference</Type>
    ...
    <Query type="Expand">
      ...
      <AddType type="CATMatConnection" option="with_ports_and_cnxs">
        <PointedRetriever option="materials" role="CATMaterialToReferenceLink"></PointedRetriever>
      </AddType>
      <AddType type="VPMCfgInstanceConfiguration" option="with_ports_and_cnxs">
        <FilterOnSRs option="filter_mappings" role="CFG_ConfiguredInstance" category="Reference7" state="NotOpened" behavior="Remove" addBrokenSRsToFilter="false"></FilterOnSRs>
        <PointedRetriever role="CFG_SelectedConfiguration" category="Reference4"></PointedRetriever>
      </AddType>
      <AddType type="VPMCfgEffectivity">
        <FilterOnSRs option="filter_effectivities" role="CFG_FilterableObject" state="NotOpened" behavior="Remove" addBrokenSRsToFilter="false"></FilterOnSRs>
        <FilterOnSRs option="filter_broken_effectivities" role="CFG_FilterableObject" state="NotOpened" behavior="Remove" addBrokenSRsToFilter="true"></FilterOnSRs>
      </AddType>
	  ...
	  <AddType type="DIFAttachedPresentation" option="with_ports_and_cnxs">
        <PointedRetriever option="layouts" role="DIFAttachedPresentation"></PointedRetriever>
      </AddType>
  ...
  <Profile name="NavigateChickenRunFasteners" OldTypingSupport='Y'>
    ...
    <Query type="Navigate">
      ...
      <Path from="VPMInstance" to="CATMCXMechanicalConnection" role="Fst_Realization" category="Reference" minorSensitivity="true" direct="false"></Path>
      <Path from="VPMInstance" to="CATMCXMechanicalConnection" role="MCX_ImpactedOut" category="Reference5" minorSensitivity="true" specialTagForFastener="true" direct="false"></Path>
    </Query>
    <Level state="Light">None</Level>
    <Level state="Navigation">None</Level>
    <Level state="Full">1</Level>
   ...
   <Profile name="NavigateChickenRunPPR" OldTypingSupport='Y'>
    ...
    <Query type="Navigate">
      ...
      <Path from="DELFmiFunctionInstance"  to="DELFmiProcessImplementCnx" role="PLM_ImplementLink_Source" category="Reference5" direct="false"></Path>
	  <Path from="DELFmiFunctionReference" to="DELFmiProcessImplementCnx" role="PLM_ImplementLink_Source" category="Reference5" direct="false"></Path>
    </Query>
    <Level state="Light">None</Level>
    <Level state="Navigation">None</Level>
    <Level state="Full">1</Level>
   ...
   <Profile name="CompleteComposedBO" OldTypingSupport='Y' PathSupport='Y' ReversePath='Y'>
   ...
   <Profile name="LoadConfigModel" OldTypingSupport='Y'>
    ...
    <Query type="Navigate">
      ...
      <Path from="PLMCoreInstance"  to="VPMCfgEffectivity" role="CFG_FilterableObject" category="Reference7" direct="false"></Path>
	  <Path>
	  ...
	  <Path from="PLMCoreReference"  to="VPMCfgApplicability" direct="false"></Path>
	  <Path>
        <Step from="PLMCoreReference" to="VPMCfgContext" direct="false"/>
		<Step from="VPMCfgContext" to="Model" role="CFG_AttachedModel" category="Reference" direct="true"/>
      </Path>
	  <Path from="PLMConnection"  to="PLMConnection" role="CFG_ExpressionCriteria" category="Reference" direct="true"></Path>
      <Path from="PLMConnection"  to="PLMConnection" role="CFG_ExpressionImpactingCriteria" category="Reference4" direct="true"></Path>
	  <Path from="PLMConnection"  to="PLMConnection" role="CFG_InheritedEffectivity" category="Reference4" direct="true"></Path>
	  <Path from="PLMConnection"  to="Model" role="CFG_CriteriaModel" category="Reference" direct="true"></Path>
	  <Path>
	  ...
	  <Path from="PLMConnection"  to="Configuration Feature" role="CFG_ExpressionCriteria" category="Reference" direct="true"></Path>
    </Query>
    <Level state="Light">None</Level>
    <Level state="Navigation">None</Level>
